...
> **NOTE**: スクリーンショット・GIF は開発中のものです。最新 UI は `docs/images/` で随時更新します。
...
$ export DATABASE_URL=postgresql://localhost/sochi_blocks_dev
...
| 窓口                 | URL                                                                                                            | 用途             |
| ------------------ | -------------------------------------------------------------------------------------------------------------- | -------------- |
| GitHub Issues      | [https://github.com/sochi-lab/sochi-blocks/issues](https://github.com/sochi-lab/sochi-blocks/issues)           | バグ報告・機能要望      |
| GitHub Discussions | [https://github.com/sochi-lab/sochi-blocks/discussions](https://github.com/sochi-lab/sochi-blocks/discussions) | Q\&A・雑談・提案     |
